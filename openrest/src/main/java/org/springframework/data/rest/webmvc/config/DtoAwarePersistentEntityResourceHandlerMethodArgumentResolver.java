...
public class DtoAwarePersistentEntityResourceHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
	...
	private final DtoToEntityConversionManager conversionManager;
	...
	public DtoAwarePersistentEntityResourceHandlerMethodArgumentResolver(
			...
			@NonNull DtoToEntityConversionManager conversionManager) {
	...
	public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
		...
		if (incoming.isPatchRequest()) {
			...
			wrapper = conversionManager.merge(contentType, incoming.getServerHttpRequest(), invoker, id, dtoParam);
		} else {
			wrapper = conversionManager.create(contentType, incoming.getServerHttpRequest(), dtoParam);
		}
