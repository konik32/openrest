 ...
 *
 */
public class DefaultEntityFromDtoCreatorAndMerger implements EntityFromDtoCreator<Object, Object>, EntityFromDtoMerger<Object, Object> {
    ...
    public DefaultEntityFromDtoCreatorAndMerger(DtoDomainRegistry registry, BeanFactory beanFactory, PersistentEntities persistentEntities) {
    ...
    public Object create(Object from, DtoInformation dtoInfo) {
        ...
        if (!dtoInfo.getEntityCreatorType().equals(DefaultEntityFromDtoCreatorAndMerger.class)) {
            EntityFromDtoCreator<Object, Object> creator = (EntityFromDtoCreator<Object, Object>) beanFactory.getBean(dtoInfo
                    .getEntityCreatorType());
    ...
    private Object createByFields(final Object from, final DtoInformation dtoInfo) {
        ...
        ReflectionUtils.doWithFields(from.getClass(), new FieldCallback() {
            ...
            public void doWith(Field field) throws IllegalArgumentException, IllegalAccessException {
                ...
                if (entityField == null)
                    return;
                if(isFinalOrStatic(entityField)) return;
    ...
    public void merge(Object from, Object entity, DtoInformation dtoInfo) {
        ...
        if (!dtoInfo.getEntityMergerType().equals(DefaultEntityFromDtoCreatorAndMerger.class)) {
            EntityFromDtoMerger<Object, Object> creator = (EntityFromDtoMerger<Object, Object>) beanFactory.getBean(dtoInfo
                    .getEntityMergerType());
