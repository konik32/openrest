...
public class PartTreeSpecificationBuilder {
	...
	private List<String[]> strParameters = new ArrayList<String[]>();
	...
	public void append(String id) {
		root.addPart(new TempPart("eq", getIdPropertyName(domainPersistentEntity), 1));
		strParameters.add(new String[] { id });
	}
	...
	public void append(PersistentEntity<?, ?> parentPersistentEntity, String propertyName, String parentId) throws ResourceNotFoundException {
		...
		root.addPart(new TempPart("eq", partName, 1));
		strParameters.add(new String[] { parentId });
		// }
		// }
	}
