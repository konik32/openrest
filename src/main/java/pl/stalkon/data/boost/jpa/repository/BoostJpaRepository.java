package pl.stalkon.data.boost.jpa.repository;
...
public class BoostJpaRepository implements BoostRepository {
	 ...
	 */
	@Transactional
	private Page<Object> findAll(BoostSpecification spec, Pageable pageable,
	 ...
	 * @return
	 */
	protected TypedQuery<Object> getQuery(BoostSpecification spec, Sort sort,
			Class<Object> domainClass) {
