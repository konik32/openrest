...
public class UnanimousAccessDecitionManagerTest {

    private UnanimousAccessDecisionManger manager;
    ...
    @Before
    public void setUp() {
        manager = new UnanimousAccessDecisionManger();
    ...
    @Test
    public void shouldGrantAccessOnyAllGrantingStrategies() throws Exception {
        // given
        List<DtoAuthorizationStrategy> strategies = Arrays.asList(grantingAccessStrategy, grantingAccessStrategy, grantingAccessStrategy);
        // when
    ...
    @Test(expected = AccessDeniedException.class)
    public void shouldDenyOnAnyDenyingStrategy() throws Exception {
        // given
        manager.setAllowIfAllAbstainDecisions(false);
        List<DtoAuthorizationStrategy> strategies = Arrays
                .asList(grantingAccessStrategy, denyingAccessStrategy, abstainingAccessStrategy);
        // when
        int result = manager.isAuthorized(strategyParam, strategyParam, strategyParam, strategies);
    }
}
