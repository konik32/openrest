...
public class QueryDslPredicateInvoker {
    ...
    public Iterable<Object> invokeFindAll(Predicate predicate, PredicateContext predicateContext, Pageable pageable) {
        return pageable == null ? invokeFindAll(predicate, predicateContext) : repository.findAll(predicate, predicateContext, pageable);
    }
    ...
    public Object invokeCount(Predicate predicate, PredicateContext predicateContext) {
        return repository.count(predicate, predicateContext);
    }
}
