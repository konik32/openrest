...
public class QSortMethodArgumentResolver implements
	...
	public Object resolveArgument(MethodParameter parameter,
		...
		Sort sort = sortResolver.resolveArgument(parameter, mavContainer,
				webRequest, binderFactory);
		ResourceMetadata resourceMetadata = resourceMetadataResolver
				.resolveArgument(parameter, mavContainer, webRequest,
						binderFactory);
		FilterableEntityInformation entityInfo = filterableEntityRegistry
				.get(resourceMetadata.getDomainType());
